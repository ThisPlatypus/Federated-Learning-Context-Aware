...
from ut import CMAPSSBinaryDataset
from tqdm import tqdm

client_id = 20  # 0–25
sensor_id = client_id + 1

raw = load_data("FD001")[1]  # Get the training dataframe
...
#model = CNN1DSequenceClassifier(input_channels=1, seq_len=ds[0][0].shape[0], num_classes=1)
